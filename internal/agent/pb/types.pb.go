...
func (x *NotificationSubscription) GetHoldoffSeconds() int32 {
	if x != nil {
		return x.HoldoffSeconds
	}
	return 0
}

func (x *NotificationSubscription) GetTemplate() string {
	if x != nil {
		return x.Template
	}
	return ""
...
func (x *NotificationDispatcher) GetBotToken() string {
	if x != nil {
		return x.BotToken
	}
	return ""
...
func (x *NotificationDispatcher) GetChatId() string {
	if x != nil {
		return x.ChatId
	}
	return ""
...
func (x *NotificationDispatcher) GetMessageThreadId() string {
	if x != nil {
